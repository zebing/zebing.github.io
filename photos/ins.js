    ...
    var render = function render(res) {
      ...
      for (var j = 0, len2 = res.list.length; j < len2; j++) {
        ...
        for (var i = 0, len = data.link.length; i < len; i++) {
          var minSrc = 'http://oqpzgrxct.bkt.clouddn.com/' + data.link[i]+'?imageView2/1/w/200/h/200/q/75|imageslim';
          var src = 'http://oqpzgrxct.bkt.clouddn.com/' + data.link[i];
          var type = data.type[i];
          var target = src;

          liTmpl += '<figure class="thumb" itemprop="associatedMedia" itemscope="" itemtype="http://schema.org/ImageObject">\
                <a href="' + src + '" itemprop="contentUrl" data-size="640x640" data-type="' + type + '" data-target="' + target + '">\
                  <img class="reward-img" data-type="' + type + '" data-src="' + minSrc + '" src="https://github.com/zebing/zebing.github.io/blob/hexo/photos/empty.png?raw=true" itemprop="thumbnail" onload="lzld(this)">\
                </a>\
